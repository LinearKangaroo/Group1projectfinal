...
{
    public partial class Fsetting : UIEditForm
    {
        public Fsetting()
        {
            InitializeComponent();
            uiPanel11.FillColor = uiPanel11.RectColor = RandomColor.GetColor(ColorScheme.Random, Luminosity.Bright);
            uiLabel1.Text = "RGB: " + uiPanel11.FillColor.R + ", " + uiPanel11.FillColor.G + ", " + uiPanel11.FillColor.B;
        ...
        {
            uiLabel4.Text = uiTrackBar1.Value.ToString();
            UIStyles.GlobalFontScale = uiTrackBar1.Value;
        }
    }
}
